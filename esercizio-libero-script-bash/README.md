...
## Descrizione
Come esercizio ho scritto uno script che ritorna la lista di tutti gli utenti di sistema con i relativi gruppi di appartenenza, lo script utilizza l'utility "getopt" per gestire i flags personalizzati del comando. 
